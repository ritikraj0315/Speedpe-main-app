                      ...
                      return ListView(
                          ...
                          children: [
                            RequestTypeButton(
                              ...
                              length : widget.requestType == RequestType.sendRequest ? requestMoneyController.ownPendingRequestedMoneyList.length :  widget.requestType == RequestType.withdraw ? requestMoneyController.pendingWithdraw.length : requestMoneyController.pendingRequestedMoneyList.length,
                            ),
    ...
    return TextButton(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: Get.find<RequestedMoneyController>().requestTypeIndex == index ? Theme.of(context).primaryColor : Theme.of(context).cardColor,
