...
import 'package:six_cash/view/screens/auth/permission/transaction_contact_permission.dart';
    ...
    return GetBuilder<TransactionMoneyController>(builder: (contactController) {
      if (contactController.getContactPermissionStatus) {
        return SliverToBoxAdapter(
          child: Column(children: [
            InkWell(
              onTap: () {
                Get.to(() => const TransactionContactPermission());
              },
              child: Lottie.asset(Images.contactPermissionDeniAnimation,
                  width: 120.0,
                  fit: BoxFit.contain,
      ...
      return SliverList(
        delegate: SliverChildBuilderDelegate(
          (context, index) =>
              contactController.filterdContacts[index].contact == null
                  ? const SizedBox()
                  : Column(
                      ...
                      children: [
                        ...
                        CustomInkWell(
                          highlightColor: ColorResources.getBlackAndWhite()
                              .withOpacity(0.3),
                          onTap: () => contactController.isButtonClick
                              ? null
                              : contactController.contactOnTap(
                        ...
                        Padding(
                          padding:
                              const EdgeInsets.only(left: 65.0, right: 35.0),
                          child: Divider(
                              color: ColorResources.getDarkGrayColor(),
                              height: Dimensions.dividerSizeExtraSmall),
                        ),
                      ],
                    ),
