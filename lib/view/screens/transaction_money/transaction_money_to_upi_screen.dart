...
class TransactionMoneyToUpiScreen extends StatefulWidget {
  final bool? fromEdit;
  final String? phoneNumber;

  const TransactionMoneyToUpiScreen(
      {Key? key, this.fromEdit, this.phoneNumber})
      : super(key: key);

  @override
  State<TransactionMoneyToUpiScreen> createState() => _TransactionMoneyToUpiScreenState();
}

class _TransactionMoneyToUpiScreenState extends State<TransactionMoneyToUpiScreen> {
