...
class AuthController extends GetxController implements GetxService {
  ...
  Future<Response> checkUsername(String userName) async {
    _isLoading = true;
    update();
    Response response = await authRepo.checkUsername(userName: userName);
  ...
  Future<Response> updateUsername(String userName) async {
    _isLoading = true;
    update();
    Response response = await authRepo.updateUsername(userName: userName);
  ...
  Future<Response> addCardDetails(String cardNo, String cardExpiry,
      String cardHName, String cardType) async {
    _isLoading = true;
    update();
    Response response = await authRepo.addCardDetails(
        cardNo: cardNo,
  ...
  Future<ResponseModel> phoneLoginVerify(String phoneNumber, String otp,
      String countryCode, String nationalNumber) async {
    _isLoading = true;
    update();
    Response response = await authRepo.verifyLoginPhoneNumber(
  ...
  Future<Response> resetPassword(String? phoneNumber, String? otp,
