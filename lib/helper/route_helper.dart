...
import 'package:six_cash/view/screens/choose_theme/choose_theme.dart';
...
import 'package:six_cash/view/screens/groups/joined_group/joined_group_screen.dart';
...
import '../view/screens/bill_manage/search_service.dart';
...
class RouteHelper {
  ...
  static const String joinedGroupScreen = '/joined_group_screen';
  ...
  static getVerifyRoute(
          {String? phoneNumber,
          String? userType,
          String? countryCode,
          String? nationalNumber}) =>
      '$verifyScreen?phone_number=${Uri.encodeComponent(phoneNumber ?? 'null')}&user_type=${Uri.encodeComponent(userType ?? 'user_type')}&country_code=${Uri.encodeComponent(countryCode ?? 'country_code')}&national_number=${Uri.encodeComponent(nationalNumber ?? 'national_number')}';
  ...
  static getChooseThemeRoute() => chooseTheme;

  static getJoinedGroupScreenRoute() => joinedGroupScreen;

  static getSearchServiceRoute() => searchService;

  static getNotificationScreenRoute() => notification;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          ...
          final String? userType =
              Uri.decodeComponent(Get.parameters['user_type']!) != 'null'
                  ? Uri.decodeComponent(Get.parameters['user_type']!)
                  : null;
          final String? countryCode =
              Uri.decodeComponent(Get.parameters['country_code']!) != 'null'
                  ? Uri.decodeComponent(Get.parameters['country_code']!)
                  : null;
          final String? nationalNumber =
              Uri.decodeComponent(Get.parameters['national_number']!) != 'null'
                  ? Uri.decodeComponent(Get.parameters['national_number']!)
                  : null;
    ...
    GetPage(
        name: pinSetScreen,
        page: () => PinSetScreen(
              signUpBody: SignUpBody.fromJson(jsonDecode(
    ...
    GetPage(name: chooseTheme, page: () => const ChooseTheme()),
    GetPage(name: joinedGroupScreen, page: () => const JoinedGroupScreen()),
    GetPage(name: searchService, page: () => const SearchServiceScreen()),
