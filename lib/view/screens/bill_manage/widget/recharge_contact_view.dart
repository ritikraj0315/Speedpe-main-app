...
class RechargeContactView extends StatelessWidget{
  //final String? transactionType;
  const RechargeContactView({ Key? key}) : super(key: key);
          ...
          children: [
            if(index == 0) Container(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Text('phone_book'.tr, style: walsheimMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Theme.of(context).highlightColor),),
                ],
              ),
            ),
            ...
            const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge),
              child: Offstage(offstage: !contactController.filterdContacts[index].isShowSuspension,
                child: Text(
                  ...
                  style: walsheimMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: ColorResources.getGreyBaseGray1()),
                ),
              ),
            ),

            CustomInkWell(
              highlightColor: ColorResources.getBlackAndWhite().withOpacity(0.3),
              onTap:() => contactController.isButtonClick ? null : contactController.contactOnTap(index, "transactionType"),
            ...
            Padding(
              ...
              child: Divider(color: ColorResources.getDarkGrayColor(), height: Dimensions.dividerSizeExtraSmall),
            ),
          ],
        ),
