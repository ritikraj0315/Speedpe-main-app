...
class _AllServiceScreenState extends State<AllServiceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppbarHomeElement(title: 'All Services'.tr),
...
class CategoryContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<WebsiteLinkController>(builder: (websiteLinkController) {
      List<WebsiteLinkModel> filteredList = websiteLinkController.getReversedFilteredWebsiteList(filterText);
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return CustomInkWell(
              onTap: () {
                // Handle tap
                Get.snackbar("title", filteredList[index].category!);
              },
              child: Container(
