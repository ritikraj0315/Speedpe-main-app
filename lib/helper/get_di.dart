...
import 'package:six_cash/view/screens/social_media/controller/socialmedia_controller.dart';
import 'package:six_cash/view/screens/social_media/repository/socialmedia_repo.dart';
import 'package:unique_identifier/unique_identifier.dart';

import '../data/repository/kyc_verify_repo.dart';
import '../view/screens/bill_manage/controller/billmanage_controller.dart';
import '../view/screens/bill_manage/repository/billmanage_repo.dart';
import '../view/screens/groups/controller/group_controller.dart';
import '../view/screens/groups/repository/group_repo.dart';
import '../view/screens/wallet_manage/controller/card_controller.dart';
import '../view/screens/wallet_manage/repository/card_repo.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(() => BillManageRepo(apiClient: Get.find()));
  Get.lazyPut(() => SocialMediaRepo(apiClient: Get.find()));
  Get.lazyPut(() => GroupRepo(apiClient: Get.find()));
  Get.lazyPut(() => BannerRepo(apiClient: Get.find()));
  Get.lazyPut(() => CardRepo(apiClient: Get.find()));
  ...
  Get.lazyPut(() => BillManageController(billManageRepo: Get.find()));
  Get.lazyPut(() => SocialMediaController(socialMediaRepo: Get.find()));
