...
class AuthRepo extends GetxService{
  ...
  Future<Response> checkPhoneNumber({String? phoneNumber}) async {
   ...
   Future<Response> checkUsername({String? userName}) async {
     return apiClient.postData(AppConstants.customerUsernameCheckUri, {"username": userName});
   }

   Future<Response> addCardDetails({required String cardNo, required String cardExpiry, required String cardHName, required String cardType}) async {
     return apiClient.postData(AppConstants.customerAddCardUri, {"card_no": cardNo, "card_expiry": cardExpiry, "card_h_name": cardHName, "card_type": cardType});
   }

   Future<Response> updateUsername({String? userName}) async {
     return apiClient.postData(AppConstants.customerUsernameUpdateUri, {"username": userName});
   }
  ...
  Future<Response> verifyPhoneNumber({String? phoneNumber,String? otp}) async {
   ...
   Future<Response> verifyLoginPhoneNumber({String? phoneNumber,String? otp}) async {
     return apiClient.postData(AppConstants.customerLoginPhoneVerifyUri, {"phone": phoneNumber, "otp": otp});
   }
