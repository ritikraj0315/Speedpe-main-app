...
class AppConstants {
  static const String appName = 'SpeedPe';
  static const String baseUrl = 'https://speedpe.net';
  ...
  static const String customerUsernameCheckUri =
      '/api/v1/customer/auth/check-username';
  static const String customerUsernameUpdateUri =
      '/api/v1/customer/update-username';
  static const String customerPhoneVerifyUri =
      '/api/v1/customer/auth/verify-phone';
  static const String customerLoginPhoneVerifyUri =
      '/api/v1/customer/auth/verify-login-phone';
  ...
  static const String verifyKycOtp = '/api/v1/customer/verify-kyc-otp';
  ...
  static const String customerSearchBuddy = '/api/v1/customer/search-buddy';
  static const String customerBuddyProfile = '/api/v1/customer/buddy-profile';
  static const String customerFollowUser = '/api/v1/customer/follow-user';
  static const String customerUnfollowUser = '/api/v1/customer/unfollow-user';
  static const String customerSendMessage = '/api/v1/customer/send-message';
  static const String customerGetChats = '/api/v1/customer/get-chats';
  static const String customerGetMessages = '/api/v1/customer/get-messages';

  static const String customerGetFollowing = '/api/v1/customer/get-following';
  static const String customerGetInviteMember = '/api/v1/customer/get-invite';
  static const String customerCreateGroupUri = '/api/v1/customer/create-group';
  static const String customerAddMemberToGroupUri = '/api/v1/customer/add-member';
  static const String customerGetJoinedGroup = '/api/v1/customer/get-joined-group';
  static const String customerSendGroupMessage = '/api/v1/customer/send-group-message';
  static const String customerGetGroupMessages = '/api/v1/customer/get-group-messages';
  static const String customerGetGroupMembers = '/api/v1/customer/group-members';
  static const String customerRemoveMember = '/api/v1/customer/remove-member';
  static const String customerDeleteGroup = '/api/v1/customer/delete-group';
  static const String customerExitGroup = '/api/v1/customer/exit-group';
  static const String customerPromoteAdmin = '/api/v1/customer/promote-admin';
  static const String customerGetMemberDetail = '/api/v1/customer/member-detail';
  static const String customerGetGroupDetail = '/api/v1/customer/group-detail';
  static const String customerChangeGroupOpenStatus = '/api/v1/customer/change-group-open-status';
  static const String customerUnsentMessage = '/api/v1/customer/unsent-message';

  static const String customerAddCardUri = '/api/v1/customer/add-card';
  static const String customerGetCard = '/api/v1/customer/get-card';
