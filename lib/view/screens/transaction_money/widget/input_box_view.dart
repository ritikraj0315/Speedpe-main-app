                ...
                child: Column(
                  children: [ Container(
                    ...
                    child: TextField(inputFormatters: <TextInputFormatter>[
                      ...
                      style: walsheimBold.copyWith(fontSize: 34, color: Theme.of(context).primaryColor),
                      decoration: InputDecoration(
                        isCollapsed : true,
                        hintText:PriceConverter.balanceInputHint(),
                        border : InputBorder.none, focusedBorder: const UnderlineInputBorder(),
                        hintStyle: walsheimBold.copyWith(
                          fontSize: 34, color: Theme.of(context).highlightColor.withOpacity(0.7),
                        ),
