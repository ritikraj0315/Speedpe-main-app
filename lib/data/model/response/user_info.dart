...
class UserInfo {
  ...
  factory UserInfo.fromJson(Map<String, dynamic> json) => UserInfo(
        ...
        pendingBalance: json["pending_balance"] != null
            ? json["pending_balance"].toDouble()
            : 0,
        pendingWithdrawCount: json["pending_withdraw_count"] != null
            ? int.parse(json["pending_withdraw_count"].toString())
            : 0,
        transactionLimits:
            TransactionLimit.fromJson(json["transaction_limits"]),
      );
}
...
class TransactionLimit {
  ...
  factory TransactionLimit.fromJson(Map<String, dynamic> json) =>
      TransactionLimit(
        ...
        monthlyAddMoneyAmount:
            double.parse('${json["monthly_add_money_amount"]}'),
        dailySendMoneyCount: int.parse('${json["daily_send_money_count"]}'),
        monthlySendMoneyCount: int.parse('${json["monthly_send_money_count"]}'),
        dailySendMoneyAmount:
            double.parse('${json["daily_send_money_amount"]}'),
        monthlySendMoneyAmount:
            double.parse('${json["monthly_send_money_amount"]}'),
        ...
        monthlyCashOutAmount:
            double.parse('${json["monthly_cash_out_amount"]}'),
        dailySendMoneyRequestCount:
            int.parse('${json["daily_send_money_request_count"]}'),
        monthlySendMoneyRequestCount:
            int.parse('${json["monthly_send_money_request_count"]}'),
        dailySendMoneyRequestAmount:
            double.parse('${json["daily_send_money_request_amount"]}'),
        monthlySendMoneyRequestAmount:
            double.parse('${json["monthly_send_money_request_amount"]}'),
        dailyWithdrawRequestCount:
            int.parse('${json["daily_withdraw_request_count"]}'),
        monthlyWithdrawRequestCount:
            int.parse('${json["monthly_withdraw_request_count"]}'),
        dailyWithdrawRequestAmount:
            double.parse('${json["daily_withdraw_request_amount"]}'),
        monthlyWithdrawRequestAmount:
            double.parse('${json["monthly_withdraw_request_amount"]}'),
      );
}
